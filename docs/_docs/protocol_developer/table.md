...
![Simple table example]({{ site.baseurl }}{% link _docs/protocol_developer/images/simple_table-2.png %})
...
![Simple table example]({{ site.baseurl }}{% link _docs/protocol_developer/images/simple_table-4.png %})
...
![Simple table example]({{ site.baseurl }}{% link _docs/protocol_developer/images/simple_table-5.png %})
