...
![choosing users]({{ site.baseurl }}{% link _docs/configuration/images/users/settings-menu.png %})

Then enter the user information and click **New User**

![creating user]({{ site.baseurl }}{% link _docs/configuration/images/users/new-user.png %})

This will bring you to the user information page where user contact information should be entered:

![new user page]({{ site.baseurl }}{% link _docs/configuration/images/users/new-user-page.png %})
...
![add user to group]({{ site.baseurl }}{% link _docs/configuration/images/users/add-to-group.png %})
