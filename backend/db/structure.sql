...
) ENGINE=InnoDB AUTO_INCREMENT=23772 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=513546 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
SET character_set_client = @saved_cs_client;
DROP TABLE IF EXISTS `view_samples_new`;
/*!50001 DROP VIEW IF EXISTS `view_samples_new`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `view_samples_new` (
  `id` tinyint NOT NULL,
  `name` tinyint NOT NULL,
  `description` tinyint NOT NULL,
  `created_at` tinyint NOT NULL,
