...
ActiveRecord::Schema.define(version: 2020_12_18_000010) do
  ...
  create_table "parameters_bak", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
  ...
  create_table "user_profiles", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.integer "id", default: 0, null: false
    t.string "key"
    t.string "value"
    t.datetime "created_at", null: false
  ...
  create_table "user_profiles_", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "key"
    t.string "value"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
