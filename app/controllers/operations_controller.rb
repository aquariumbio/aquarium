...
class OperationsController < ApplicationController
  ...
  def set_status
    ...
    old_item_ids = op.outputs.collect { |output| output.child_item_id }.select { |id| id }

    if ( old_status == 'error' || old_status == 'done' ) && !old_item_ids.empty?
      logger.info "Associating message"
      op.associate(
