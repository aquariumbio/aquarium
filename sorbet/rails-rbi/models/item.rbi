...
# Please rerun rake rails_rbi:models[Item] to regenerate.
...
class Item < ActiveRecord::Base
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(Item) }
...
class Item::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { override.params(block: T.proc.params(e: Item).void).returns(T::Array[Item]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Item]) }
...
class Item::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(Item::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
