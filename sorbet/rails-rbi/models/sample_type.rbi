...
# Please rerun rake rails_rbi:models[SampleType] to regenerate.
...
module SampleType::GeneratedAssociationMethods
  ...
  sig { params(value: T.any(T::Array[::ObjectType], ::ObjectType::ActiveRecord_Associations_CollectionProxy)).void }
...
class SampleType < ActiveRecord::Base
  ...
  sig { params(args: T.untyped).returns(SampleType) }
  def self.find(*args); end

  sig { params(args: T.untyped).returns(T.nilable(SampleType)) }
  def self.find_by(*args); end

  sig { params(args: T.untyped).returns(SampleType) }
  def self.find_by!(*args); end

  sig { returns(T.nilable(SampleType)) }
  def self.first; end
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(SampleType) }
...
class SampleType::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { override.params(block: T.proc.params(e: SampleType).void).returns(T::Array[SampleType]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[SampleType]) }
  def flatten(level); end

  sig { returns(T::Array[SampleType]) }
  def to_a; end
...
class SampleType::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(SampleType::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
