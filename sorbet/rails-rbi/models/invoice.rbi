...
# Please rerun rake rails_rbi:models[Invoice] to regenerate.
...
class Invoice < ActiveRecord::Base
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(Invoice) }
...
class Invoice::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { override.params(block: T.proc.params(e: Invoice).void).returns(T::Array[Invoice]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Invoice]) }
...
class Invoice::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(Invoice::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
