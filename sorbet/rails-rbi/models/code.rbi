...
# Please rerun rake rails_rbi:models[Code] to regenerate.
...
class Code < ActiveRecord::Base
  ...
  sig { params(args: T.untyped).returns(Code) }
  def self.find(*args); end

  sig { params(args: T.untyped).returns(T.nilable(Code)) }
  def self.find_by(*args); end

  sig { params(args: T.untyped).returns(Code) }
  def self.find_by!(*args); end

  sig { returns(T.nilable(Code)) }
  def self.first; end
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(Code) }
...
class Code::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { override.params(block: T.proc.params(e: Code).void).returns(T::Array[Code]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Code]) }
  def flatten(level); end

  sig { returns(T::Array[Code]) }
  def to_a; end
...
class Code::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(Code::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
