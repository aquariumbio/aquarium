...
# Please rerun rake rails_rbi:models[Upload] to regenerate.
...
module Upload::GeneratedAttributeMethods
  ...
  def upload_content_type=(value); end

  sig { returns(T::Boolean) }
  def upload_content_type?; end

  sig { returns(T.nilable(String)) }
  def upload_file_name; end

  sig { params(value: T.nilable(String)).void }
  def upload_file_name=(value); end

  sig { returns(T::Boolean) }
  def upload_file_name?; end

  sig { returns(T.nilable(Integer)) }
  def upload_file_size; end

  sig { params(value: T.nilable(Integer)).void }
  def upload_file_size=(value); end

  sig { returns(T::Boolean) }
  def upload_file_size?; end

  sig { returns(T.nilable(ActiveSupport::TimeWithZone)) }
  def upload_updated_at; end

  sig { params(value: T.nilable(T.any(DateTime, Date, Time, ActiveSupport::TimeWithZone))).void }
  def upload_updated_at=(value); end
...
module Upload::GeneratedAssociationMethods
  ...
  sig { params(value: T.any(T::Array[::DataAssociation], ::DataAssociation::ActiveRecord_Associations_CollectionProxy)).void }
...
class Upload < ActiveRecord::Base
  ...
  sig { params(args: T.untyped).returns(Upload) }
  def self.find(*args); end

  sig { params(args: T.untyped).returns(T.nilable(Upload)) }
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(Upload) }
...
class Upload::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { override.params(block: T.proc.params(e: Upload).void).returns(T::Array[Upload]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Upload]) }
  def flatten(level); end

  sig { returns(T::Array[Upload]) }
  def to_a; end
...
class Upload::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(Upload::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
