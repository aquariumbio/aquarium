...
# Please rerun rake rails_rbi:models[Library] to regenerate.
...
class Library < ActiveRecord::Base
  ...
  sig { params(args: T.untyped).returns(Library) }
  def self.find(*args); end

  sig { params(args: T.untyped).returns(T.nilable(Library)) }
  def self.find_by(*args); end

  sig { params(args: T.untyped).returns(Library) }
  def self.find_by!(*args); end

  sig { returns(T.nilable(Library)) }
  def self.first; end
  ...
  sig { params(attributes: T.untyped, block: T.untyped).returns(Library) }
...
class Library::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { override.params(block: T.proc.params(e: Library).void).returns(T::Array[Library]) }
  def each(&block); end

  sig { params(level: T.nilable(Integer)).returns(T::Array[Library]) }
  def flatten(level); end

  sig { returns(T::Array[Library]) }
  def to_a; end
...
class Library::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  ...
  sig { params(block: T.nilable(T.proc.void)).returns(Library::ActiveRecord_AssociationRelation) }
  def unscoped(&block); end
