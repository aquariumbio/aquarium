...
# Please rerun bundle exec rake rails_rbi:models[AllowableFieldType] to regenerate.
...
class AllowableFieldType < ActiveRecord::Base
  ...
  extend AllowableFieldType::QueryMethodsReturningRelation
  RelationType = T.type_alias { T.any(AllowableFieldType::ActiveRecord_Relation, AllowableFieldType::ActiveRecord_Associations_CollectionProxy, AllowableFieldType::ActiveRecord_AssociationRelation) }
end

module AllowableFieldType::QueryMethodsReturningRelation
  ...
  sig { params(args: T.untyped).returns(AllowableFieldType::ActiveRecord_Relation) }
  def select(*args); end
...
module AllowableFieldType::QueryMethodsReturningAssociationRelation
  ...
  sig { params(args: T.untyped).returns(AllowableFieldType::ActiveRecord_AssociationRelation) }
  def select(*args); end
...
class AllowableFieldType::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  include AllowableFieldType::QueryMethodsReturningRelation
...
class AllowableFieldType::ActiveRecord_AssociationRelation < ActiveRecord::AssociationRelation
  include AllowableFieldType::ActiveRelation_WhereNot
  include AllowableFieldType::CustomFinderMethods
  include AllowableFieldType::QueryMethodsReturningAssociationRelation
  Elem = type_member(fixed: AllowableFieldType)
end
