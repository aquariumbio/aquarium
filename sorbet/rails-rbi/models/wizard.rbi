...
module Wizard::GeneratedAssociationMethods
  ...
  sig { returns(::Locator::ActiveRecord_Associations_CollectionProxy) }
  def locators; end

  sig { params(value: T.any(T::Array[::Locator], ::Locator::ActiveRecord_Associations_CollectionProxy)).void }
  def locators=(value); end
end
