...
RSpec.describe OperationTypesController, type: :controller do
  ...
  let(:frontend_message_json) do
    {
      ...
      'protocol' => {
        'model' => {
          'model' => 'Code', 'record_methods' => {}, 'record_getters' => {}
        },
        'name' => 'protocol',
  ...
  describe 'creating operation types' do
    ...
    it 'should accept operation type param' do
      ...
      expect(response_hash.keys).to eq(%i[id name category deployed on_the_fly created_at updated_at field_types protocol precondition cost_model documentation test])
    end
  end
end
