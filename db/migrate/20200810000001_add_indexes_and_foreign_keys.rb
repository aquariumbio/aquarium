...
class AddIndexesAndForeignKeys < ActiveRecord::Migration
  ...
  def change
    ...
    add_index       :account_logs, :row1 rescue nil
    add_index       :account_logs, :row2 rescue nil
    ...
    # already indexed on user_id
    add_index       :accounts, :operation_id rescue nil
    ...
    add_index       :data_associations, [ :parent_class, :parent_id ] rescue nil
    ...
    remove_index    :field_types, name: "index_field_types_on_sample_type_id" rescue nil
    add_index       :field_types, [ :parent_class, :parent_id ] rescue nil

    # field_values
    # already indexed on field_type_id
    # already indexed on allowable_field_type_id
    # remove index on parent_id (index_field_values_on_sample_id)
    remove_index    :field_values, name: "index_field_values_on_sample_id" rescue nil
    add_index       :field_values, [ :parent_class, :parent_id ] rescue nil
    ...
    # invoices
    add_index       :invoices, :user_id rescue nil
    add_index       :invoices, :budget_id rescue nil
    add_foreign_key :invoices, :users, on_delete: :cascade rescue nil
    add_foreign_key :invoices, :budgets, on_delete: :cascade rescue nil

    # items
    # already indexed on object_type_id
    add_index       :items, :sample_id rescue nil
    add_index       :items, :locator_id rescue nil
    ...
    # job_associations
    add_index       :job_associations, :job_id rescue nil
    add_index       :job_associations, :operation_id rescue nil
    ...
    add_index       :part_associations, :part_id rescue nil
    ...
    # plans
    # already indexed on user_id
    add_index       :plans, :budget_id rescue nil
    add_foreign_key :plans, :budgets, on_delete: :cascade rescue nil
    add_foreign_key :plans, :users, on_delete: :cascade rescue nil

    # samples
    add_index       :samples, :sample_type_id rescue nil
    add_index       :samples, :user_id rescue nil
    ...
    # timings
    add_index       :timings, [ :parent_class, :parent_id ] rescue nil

    # uploads
    add_index       :uploads, :job_id rescue nil
    ...
    add_index       :user_budget_associations, :budget_id rescue nil
    add_index       :user_budget_associations, :user_id rescue nil
    ...
    # wires
    add_index       :wires, :from_id rescue nil
    add_index       :wires, :to_id rescue nil
